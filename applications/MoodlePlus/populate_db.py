...
db.student_registrations.insert(student_id=0,registered_course_id=0)
db.student_registrations.insert(student_id=0,registered_course_id=1)
db.student_registrations.insert(student_id=0,registered_course_id=2)
db.student_registrations.insert(student_id=0,registered_course_id=5)
db.student_registrations.insert(student_id=0,registered_course_id=7)
db.student_registrations.insert(student_id=0,registered_course_id=8)
db.student_registrations.insert(student_id=1,registered_course_id=0)
...
db.student_registrations.insert(student_id=2,registered_course_id=0)
